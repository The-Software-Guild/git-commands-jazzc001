 ...
 */
public class CommetingCode {
    public static void main(String[] args) {
        // Comments are written to explain code in easily
        // understandable way
        // Basically for single lines
        //anything after // is considreed a comment
        System.out.println("Normal code is conpiled and runs...");
